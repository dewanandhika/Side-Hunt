...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 26 Jun 2025 pada 21.15
...
-- Database: `sh_new`
--
CREATE DATABASE IF NOT EXISTS `sh_new` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `sh_new`;
...
CREATE TABLE IF NOT EXISTS `payments` (
  ...
  PRIMARY KEY (`id`),
  KEY `payments_created_at_status_index` (`created_at`,`status`),
...
CREATE TABLE IF NOT EXISTS `pekerjaans` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `pekerjaans_pembuat_foreign` (`pembuat`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `pelamars` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) UNSIGNED NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `pelamars_user_id_foreign` (`user_id`),
  KEY `pelamars_job_id_foreign` (`job_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `transaksis` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`kode`),
  KEY `transaksis_pembuat_id_foreign` (`pembuat_id`),
  KEY `transaksis_pekerja_id_foreign` (`pekerja_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  UNIQUE KEY `users_telpon_unique` (`telpon`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `wire_actions` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `wire_attachments` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `wire_participants` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  `conversation_id` bigint(20) UNSIGNED NOT NULL,
