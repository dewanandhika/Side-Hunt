...
<div class="container login">
    ...
    <form action="/Login_account" method="POST">
        ...
        <input type="password" class="inp password" maxlength="15" name="password" placeholder="Masukkan Password"
...
<script>
    ...
    @if(session('alert'))
        ...
        console.log(split);
        NotifyAlert(split[0], (split[1]==null?' ':split[1]),0);
    @endif
    @error('message')
        NotifyAlertSuccess('Login', '{{$message}}');
    @enderror
