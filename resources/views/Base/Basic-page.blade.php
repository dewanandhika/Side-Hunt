...
<head>
    ...
    <title>Side Haunt - {{$nama_halaman}}</title>
    <!-- Fonts -->
    {{--
    <link rel="dns-prefetch" href="//fonts.bunny.net"> --}}
    <link rel="icon" href="{{ auto_asset('img/logoOnlyIcon.svg')}}" type="image/png">
    ...
    <link rel="stylesheet" href="{{ auto_asset('css/basic-page.css') }}">
...
<body>
    ...
    <div class="landing-logo hide">
        <img src="{{ auto_asset('img/logo.svg')}}" alt="">
    </div>
    <div>
                    ...
                    <ul class="navbar-nav left normal me-auto mb-2 mb-md-0 order-0 order-md-1">
                        ...
                        <li class="nav-item dropdown position-relative">
                            ...
                            <ul class="dropdown-menu normal ms-4 ms-md-0 bg-darker hover-bg-dark">
                                ...
                                <li><a class="dropdown-item" href="/kerja/create">
                                        <div class="d-flex flex-row gap-3">
...
<script>
    ...
    function NotifyAlert(titled, message, type = null) {
        let img = null;
        if (type == null) {
            type == 0 ? img = "{{ auto_asset('img/success.svg')}}" : img = "{{ auto_asset('img/failed.svg') }}";
        }
        Swal.fire({
            title: titled,
            text: message,
    ...
    function NotifyAlertSuccess(wht, message) {
        ...
        console.log(type == 0)
        if (type == 0) {
            img = "{{ auto_asset('img/failed.svg')}}";
            titled = wht + " Gagal!"
        }
        else {

            img = "{{ auto_asset('img/success.svg')}}"
            titled = wht + " Berhasil"
        }
        Swal.fire({
            title: titled,
