...
<div class="container login">
    ...
    <form action="/Login_account" method="POST">
        ...
        <input type="password" class="inp password" maxlength="15" name="password" value="{{ old('password') }}"
            placeholder="Masukkan Password" data-bs-toggle="popover" data-bs-trigger="hover focus"
            data-bs-content="Password harus minimal (8 karakter, 1 angka, 1 huruf Kapital, 1 huruf Kecil)"
            type="checkbox" role="switch" id="LihatKataSandi">
        ...
        <div class="setara forget-password">
            <p>Lupa kata sandi?</p><a href="/forget/password">
                <p>Klik Disini</p>
            </a>
        </div>
        ...
        <div class="setara register">
            <p>Belum punya akun?</p><a href="/Register">
                <p>Register</p>
            </a>
        </div>
    </form>
